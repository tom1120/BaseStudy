 ...
 * TODO 迭代器类似公交车售票员
 */
public class DeepSimpleIterator {
	public int getSize() {
		return size;
	}
	...
	private class MyInter implements Iterator{
		//初始化指针为开始位置
	...
	public static void main(String[] args) {
		DeepSimpleIterator deepSimpleIterator=new DeepSimpleIterator();

		Iterator iterator=deepSimpleIterator.iterator();
